...
%%%%%%%% NEED TO ADD NOVISION CONDITION ZOOM0008_5m_male_noVision.mp3
...
%%%%%%%% NEED TO ADD VISION CONDITION ZOOM0008_7m_male_vision.mp3  
...
idx = 63;
    load sixt5m32222233A.mat % See above
        out.pairnum = 3;
    dd(idx) = out;
