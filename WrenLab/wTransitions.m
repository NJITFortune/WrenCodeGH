...
linkaxes(axc, 'xy'); figure(1); subplot(221);  ylim([-8 55]);
linkaxes(axu, 'xy'); figure(1); subplot(223);  ylim([0 50]);
...
linkaxes(axxc, 'xy'); figure(2); subplot(221); ylim([-8 55]);
linkaxes(axxu, 'xy'); figure(2); subplot(223);  ylim([0 50]);
