...
linkaxes(axc, 'xy'); figure(1); subplot(221);  ylim([-8 60]);  xlim([-widow-0.001, widow+0.001]);
linkaxes(axu, 'xy'); figure(1); subplot(223);  ylim([0 55]);  xlim([-widow-0.001, widow+0.001]);
